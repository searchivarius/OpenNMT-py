...
This is the version of OpenNMT that my team created at Pittsburgh machine translation marathon in May 2018. It has an additional character-aware embedding layer. [Our participation is briefly covered in the blog post](http://searchivarius.org/blog/getting-speed-neural-machine-translation-how-not-burn-yourself-pytorch). The main idea of implementing a special character aware drop-in replacement for the word embeddings belongs to our JHU team members: Adithya Renduchintala, Pamela Shapiro, and Sebastian J. Mielke.
